...
\begin{figure}[h]
	\begin{center}
		\subfloat[\centering]{{\includegraphics[width=0.2\linewidth]{imgs/trump/seed0233.png}}}%
    	\qquad
...
\begin{figure}[h]
	\begin{center}
		\subfloat[\centering]{{\includegraphics[width=0.15\linewidth]{imgs/emoji/1.png}}}%
    	\qquad
...
\begin{figure}[h!]
	\begin{center}
		\subfloat[\centering]{{\includegraphics[width=0.25\linewidth]{imgs/time1.png}}}%
    	\qquad
...
\begin{figure}[h]
	\begin{center}
		\subfloat[\centering]{{\includegraphics[width=0.25\linewidth]{imgs/attn/000001075.jpeg}}}%
    	\qquad
...
\end{figure}
 ...
 \begin{figure}[h!]
	\begin{center}
		\subfloat[\centering church]{{\includegraphics[width=0.2\linewidth \linebreak]{imgs/big/church.jpg}}}%
    	\qquad
...
All Samples generated with GPT-2 trained on various datasets.
