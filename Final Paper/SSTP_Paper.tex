...
\usepackage[letterpaper, portrait, margin=1in]{geometry} % Margin has to be 1 inch
...
\begin{figure}[h]
    ...
    \caption{Samples Generated with StyleGAN2-ADA trained on dataset of emojis}
    \label{trump}
